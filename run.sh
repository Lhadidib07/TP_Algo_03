...
# Vérifier si le répertoire TEXT_DIR n'existe pas
if [ ! -d "$TEXT_DIR" ]; then
    echo "Le répertoire $TEXT_DIR n'existe pas. Exécution du script generateur.sh..."
    bash generateur.sh
fi

# Vérifier si le répertoire TEXT_DIR n'existe pas
if [ ! -d "$WORD_DIR" ]; then
    echo "Le répertoire $WORD_DIR n'existe pas. Exécution du script generateur.sh..."
    bash generateur.sh
fi
